...
export default async function (message: Message, client: ExtendedClient & any, Discord: any): Promise<boolean> {
    ...
    if(filterResult.result) {
        ...
        const id = await warn(message.author.id, "[AUTOMOD] Your message includes disallowed markdown.", client.user.id);
        ...
        const blocked = new Discord.EmbedBuilder()
            ...
            .addFields (
                ...
                { name: "❓ Reason", value: "[AUTOMOD] Your message includes disallowed markdown." },
